        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 mb-4">
              An academic association dedicated to developing Olympiads and organizing JunctionX events, 
              fostering excellence in education and innovation.
            </p>
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="space-y-2">
              ...
              >
                {subscribed ? 'Subscribed!' : 'Join Mailing List'}
              </Button>
            </form>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © 2024 Gradient Academic Association. All rights reserved.
            </p>
